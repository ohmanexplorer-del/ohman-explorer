...
### 35. octokit/oauth-authorization-url.js
...
### 38. pulumi/pulumi-pulumiservice
...
### 46. amaanx86/oci-prometheus-sd-proxy
...
### 48. ubiquiti-community/unifi-api
...
### 50. paperclipinc/hermes-operator
...
### 51. argoproj-labs/gitops-promoter
...
### 65. AfterShip/clickhouse-sql-parser
...
### 67. Asymptote-Labs/agent-beacon
...
### 78. EternalCodeTeam/EternalCore
...
### 87. NeptuneHub/AudioMuse-AI-MusicServer
...
### 88. kagnlp/Awesome-Agentic-Security
...
### 92. IntuitionAmiga/IntuitionEngine
...
### 100. timebertt/kubectl-revisions
...
### 101. simonostendorf/kubelet-credential-provider-vault
...
### 107. ProductOfAmerica/turbo-starter
...
### 108. procore-oss/kube-binpacking-exporter
...
### 112. trixi-framework/TrixiAtmo.jl
...
### 114. simonw/scrape-fema-shelters
...
### 116. Vortalitys/PrivHunterAI-detects-access-vulnerabilities
...
### 118. Mindburn-Labs/helm-ai-kernel
...
### 123. realdatadriven/central-set-go
...
### 126. neo4j-partners/neo4j-kubernetes-operator
...
### 134. Avarok-Cybersecurity/Citadel-Protocol
...
### 136. Dash-Industry-Forum/livesim2
...
### 140. crossplane/crossplane-runtime
...
### 158. vikrantwaghmode/agentarmor-oss
...
### 164. MountainDash/nonebot-bison
...
### 170. tony-wang1990/laowang-sub-converter
...
### 173. prometheus-community/parquet-common
...
### 174. kazhuravlev/database-gateway
...
### 175. bit-nexusxtitmtdsuy/Polymarket_Bot
...
### 179. neufeldtech/secretmessage-go
...
### 191. indmdev/Free-Telegram-Store-Bot
...
### 197. ZaparooProject/zaparoo-core
...
### 198. themiralay/Proxy-List-World
...
### 211. fdciabdul/Vpngate-Scraper-API
...
### 213. pulumi/pulumi-provider-boilerplate
...
### 214. AvaProtocol/EigenLayer-AVS
...
### 220. databricks/databricks-sdk-go
...
### 221. beyond-all-reason/bar-lobby
...
### 229. home-operations/gatus-sidecar
...
### 231. Nostalgica-Reverie/Content-Monorepo
...
### 236. aws/eks-anywhere-build-tooling
...
### 238. betterstack-community/go-logging-benchmarks
...
### 245. chukwuemekawisdom/claude2api
...
### 246. guitarrapc/githubactions-lab
...
### 247. cx20/webgl-physics-examples
...
### 251. tjhop/prometheus-mcp-server
...
### 252. cagedbird043/fcm-hosts-next
...
### 254. paketo-buildpacks/dotnet-core
...
### 265. terraform-linters/tflint-ruleset-template
...
### 267. jamesroutley/news.routley.io
...
### 281. miladtahanian/Config-Collector
...
### 282. SankaVollereii/Sankanime-Web-Stream-Anime
...
### 284. pseudoyu/top-blockchain-projects
...
### 286. batazor/microservice-template-ddd
...
### 290. armin-hg/NewCobaltstrikeTeamServer
...
### 302. Mininglamp-OSS/octo-server
...
### 303. Shade-of-Gr3y/Dream-World-Revival
...
### 305. indmdev/Telegram-Store-MiniApp
...
### 311. jr200-labs/nats-iam-broker
...
### 316. fbiego/auto-follow-unfollow
...
### 324. Dev-FelixOfc/Kazuma-Mr-Bot
...
### 328. procinger/turing-pi-v2-cluster
...
### 330. ollygarden/opentelemetry-agent-skills
...
### 331. rdmurphy/actblue-ticker-tracker
...
### 345. raintree-technology/docpull
...
### 349. VPSLabCloud/VPSLab-Free-Proxy-List
...
### 350. mflRevan/unity-control-protocol
...
### 354. jobright-ai/2026-Engineering-New-Grad
...
### 358. Pettor/app-pixi-image-editor
...
### 359. alanisme/awesome-zed-extensions
...
### 362. blackwell-systems/mcp-assert
...
### 363. crossplane-contrib/function-kro
...
### 364. jobright-ai/2026-Business-Analyst-New-Grad
...
### 367. DarkKnightYHJ/AdGuardHomeList
...
### 377. italia/developers-italia-api
...
### 378. longhorn/longhorn-share-manager
...
### 380. zoharbabin/web-researcher-mcp
...
### 388. watadarkstar/react-native-nsfw-detector
...
### 390. CustomResourceDefinition/catalog
...
### 396. jonascrevecoeur/terraform-provider-azuresql
...
### 398. paperclipinc/paperclip-operator
...
### 401. thedavidweng/monarchmoney-cli
...
### 402. thedoggybrad/easylist-mirror
...
### 416. Correia-jpv/fucking-awesome-go
...
### 418. aspect-build/aspect-gazelle
...
### 420. btelolabs/btelo-coding-release
...
### 423. jobright-ai/2026-Account-New-Grad
...
### 424. k-quels/japanese-novel-ruby
...
### 427. vituha230/Neuro-Skyrim-Integration
...
### 429. BlackbirdWorks/gopherstack
...
### 436. kagenti/kagenti-extensions
...
### 442. FransDevelopment/open-agent-trust-registry
...
### 443. Sarakimz/go-secrets-scanner
...
### 448. clm-cloud-solutions/kubebolt
...
### 450. d-velop/grafana-odata-datasource
...
### 451. dcssoftware/bafoeg-manager
...
### 452. dwisiswant0/nuclei-confuser
...
### 453. netrisai/terraform-provider-netris
...
### 459. wacht-platform/frontend-api
...
### 469. terraform-linters/tflint-ruleset-aws
...
### 472. jobright-ai/2026-Software-Engineer-New-Grad
...
### 474. projectdiscovery/awesome-search-queries
...
### 476. awalsh128/cache-apt-pkgs-action
...
### 480. apache/skywalking-banyandb
...
### 483. Azure/azure-workload-identity
...
### 506. crossplane-contrib/provider-upjet-aws
...
### 507. losisin/helm-values-schema-json
...
### 510. Delta-Kronecker/V2ray-Config
...
### 511. kubevirt/hyperconverged-cluster-operator
...
### 514. sakullla/nginx-reverse-emby
...
### 530. kubernetes-sigs/kernel-module-management
...
### 537. sheawinkler/ContextLattice
...
### 541. V2RAYCONFIGSPOOL/V2RAY_SUB
...
### 542. hyperledger/fabric-x-common
...
### 543. Mellanox/doca-driver-build
...
### 545. mosandlt/Bosch-Smart-Home-Camera-Tool-HomeAssistant
...
### 546. Tushar-sonawane06/UI-Verse
