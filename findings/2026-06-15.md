...
### 43. amaanx86/oci-prometheus-sd-proxy
...
### 45. ubiquiti-community/unifi-api
...
### 47. paperclipinc/hermes-operator
...
### 48. argoproj-labs/gitops-promoter
...
### 62. AfterShip/clickhouse-sql-parser
...
### 64. Asymptote-Labs/agent-beacon
...
### 75. EternalCodeTeam/EternalCore
...
### 83. NeptuneHub/AudioMuse-AI-MusicServer
...
### 84. kagnlp/Awesome-Agentic-Security
...
### 88. IntuitionAmiga/IntuitionEngine
...
### 96. timebertt/kubectl-revisions
...
### 97. simonostendorf/kubelet-credential-provider-vault
...
### 103. ProductOfAmerica/turbo-starter
...
### 104. procore-oss/kube-binpacking-exporter
...
### 108. trixi-framework/TrixiAtmo.jl
...
### 110. simonw/scrape-fema-shelters
...
### 112. Vortalitys/PrivHunterAI-detects-access-vulnerabilities
...
### 114. Mindburn-Labs/helm-ai-kernel
...
### 119. realdatadriven/central-set-go
...
### 122. neo4j-partners/neo4j-kubernetes-operator
...
### 129. Avarok-Cybersecurity/Citadel-Protocol
...
### 131. Dash-Industry-Forum/livesim2
...
### 134. crossplane/crossplane-runtime
...
### 151. vikrantwaghmode/agentarmor-oss
...
### 157. MountainDash/nonebot-bison
...
### 163. tony-wang1990/laowang-sub-converter
...
### 166. prometheus-community/parquet-common
...
### 167. kazhuravlev/database-gateway
...
### 170. neufeldtech/secretmessage-go
...
### 183. ZaparooProject/zaparoo-core
...
### 184. themiralay/Proxy-List-World
...
### 194. pulumi/pulumi-provider-boilerplate
...
### 195. AvaProtocol/EigenLayer-AVS
...
### 200. databricks/databricks-sdk-go
...
### 201. beyond-all-reason/bar-lobby
...
### 209. home-operations/gatus-sidecar
...
### 211. Nostalgica-Reverie/Content-Monorepo
...
### 216. aws/eks-anywhere-build-tooling
...
### 218. betterstack-community/go-logging-benchmarks
...
### 225. chukwuemekawisdom/claude2api
...
### 226. guitarrapc/githubactions-lab
...
### 227. cx20/webgl-physics-examples
...
### 231. tjhop/prometheus-mcp-server
...
### 232. cagedbird043/fcm-hosts-next
...
### 234. paketo-buildpacks/dotnet-core
...
### 242. terraform-linters/tflint-ruleset-template
...
### 244. jamesroutley/news.routley.io
...
### 258. miladtahanian/Config-Collector
...
### 259. pseudoyu/top-blockchain-projects
...
### 260. batazor/microservice-template-ddd
...
### 263. armin-hg/NewCobaltstrikeTeamServer
...
### 273. Mininglamp-OSS/octo-server
...
### 274. Shade-of-Gr3y/Dream-World-Revival
...
### 276. indmdev/Telegram-Store-MiniApp
...
### 281. jr200-labs/nats-iam-broker
...
### 293. procinger/turing-pi-v2-cluster
...
### 295. ollygarden/opentelemetry-agent-skills
...
### 316. Pettor/app-pixi-image-editor
...
### 317. alanisme/awesome-zed-extensions
...
### 319. blackwell-systems/mcp-assert
...
### 320. crossplane-contrib/function-kro
...
### 330. italia/developers-italia-api
...
### 331. longhorn/longhorn-share-manager
...
### 333. zoharbabin/web-researcher-mcp
...
### 341. CustomResourceDefinition/catalog
...
### 344. jonascrevecoeur/terraform-provider-azuresql
...
### 346. paperclipinc/paperclip-operator
...
### 349. thedavidweng/monarchmoney-cli
...
### 350. thedoggybrad/easylist-mirror
...
### 362. Correia-jpv/fucking-awesome-go
...
### 364. aspect-build/aspect-gazelle
...
### 366. btelolabs/btelo-coding-release
...
### 369. k-quels/japanese-novel-ruby
...
### 372. vituha230/Neuro-Skyrim-Integration
...
### 374. BlackbirdWorks/gopherstack
...
### 380. kagenti/kagenti-extensions
...
### 385. Sarakimz/go-secrets-scanner
...
### 389. clm-cloud-solutions/kubebolt
...
### 390. d-velop/grafana-odata-datasource
...
### 391. dcssoftware/bafoeg-manager
...
### 392. dwisiswant0/nuclei-confuser
...
### 393. netrisai/terraform-provider-netris
...
### 398. wacht-platform/frontend-api
...
### 407. terraform-linters/tflint-ruleset-aws
...
### 411. projectdiscovery/awesome-search-queries
...
### 413. awalsh128/cache-apt-pkgs-action
...
### 416. apache/skywalking-banyandb
...
### 419. Azure/azure-workload-identity
...
### 440. crossplane-contrib/provider-upjet-aws
...
### 441. losisin/helm-values-schema-json
...
### 444. Delta-Kronecker/V2ray-Config
...
### 445. kubevirt/hyperconverged-cluster-operator
...
### 447. sakullla/nginx-reverse-emby
...
### 462. kubernetes-sigs/kernel-module-management
...
### 469. sheawinkler/ContextLattice
...
### 473. V2RAYCONFIGSPOOL/V2RAY_SUB
...
### 474. hyperledger/fabric-x-common
...
### 475. Mellanox/doca-driver-build
