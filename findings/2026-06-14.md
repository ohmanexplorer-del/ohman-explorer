...
### 30. williamchanrico/planet-exporter
...
### 33. pulumi/pulumi-pulumiservice
...
### 40. amaanx86/oci-prometheus-sd-proxy
...
### 42. ubiquiti-community/unifi-api
...
### 44. paperclipinc/hermes-operator
...
### 45. argoproj-labs/gitops-promoter
...
### 58. AfterShip/clickhouse-sql-parser
...
### 60. Asymptote-Labs/agent-beacon
...
### 75. NeptuneHub/AudioMuse-AI-MusicServer
...
### 78. IntuitionAmiga/IntuitionEngine
...
### 85. timebertt/kubectl-revisions
...
### 86. simonostendorf/kubelet-credential-provider-vault
...
### 89. procore-oss/kube-binpacking-exporter
...
### 93. Vortalitys/PrivHunterAI-detects-access-vulnerabilities
...
### 95. Mindburn-Labs/helm-ai-kernel
...
### 100. realdatadriven/central-set-go
...
### 103. neo4j-partners/neo4j-kubernetes-operator
...
### 110. Dash-Industry-Forum/livesim2
...
### 113. crossplane/crossplane-runtime
...
### 128. vikrantwaghmode/agentarmor-oss
...
### 140. prometheus-community/parquet-common
...
### 141. kazhuravlev/database-gateway
...
### 144. neufeldtech/secretmessage-go
...
### 156. ZaparooProject/zaparoo-core
...
### 166. pulumi/pulumi-provider-boilerplate
...
### 167. AvaProtocol/EigenLayer-AVS
...
### 171. databricks/databricks-sdk-go
...
### 172. beyond-all-reason/bar-lobby
...
### 180. home-operations/gatus-sidecar
...
### 182. Nostalgica-Reverie/Content-Monorepo
...
### 187. aws/eks-anywhere-build-tooling
...
### 189. betterstack-community/go-logging-benchmarks
...
### 196. chukwuemekawisdom/claude2api
...
### 197. guitarrapc/githubactions-lab
...
### 201. tjhop/prometheus-mcp-server
...
### 202. cagedbird043/fcm-hosts-next
...
### 204. paketo-buildpacks/dotnet-core
...
### 212. terraform-linters/tflint-ruleset-template
...
### 214. jamesroutley/news.routley.io
...
### 228. miladtahanian/Config-Collector
...
### 229. pseudoyu/top-blockchain-projects
...
### 230. batazor/microservice-template-ddd
...
### 233. armin-hg/NewCobaltstrikeTeamServer
...
### 243. Mininglamp-OSS/octo-server
...
### 248. jr200-labs/nats-iam-broker
...
### 259. procinger/turing-pi-v2-cluster
...
### 261. ollygarden/opentelemetry-agent-skills
...
### 282. Pettor/app-pixi-image-editor
...
### 283. alanisme/awesome-zed-extensions
...
### 285. blackwell-systems/mcp-assert
...
### 286. crossplane-contrib/function-kro
...
### 295. italia/developers-italia-api
...
### 296. longhorn/longhorn-share-manager
...
### 298. zoharbabin/web-researcher-mcp
...
### 306. CustomResourceDefinition/catalog
...
### 309. jonascrevecoeur/terraform-provider-azuresql
...
### 311. paperclipinc/paperclip-operator
...
### 314. thedavidweng/monarchmoney-cli
...
### 325. Correia-jpv/fucking-awesome-go
...
### 327. aspect-build/aspect-gazelle
...
### 329. btelolabs/btelo-coding-release
...
### 335. BlackbirdWorks/gopherstack
...
### 341. kagenti/kagenti-extensions
...
### 346. Sarakimz/go-secrets-scanner
...
### 350. clm-cloud-solutions/kubebolt
...
### 351. d-velop/grafana-odata-datasource
...
### 352. dcssoftware/bafoeg-manager
...
### 353. dwisiswant0/nuclei-confuser
...
### 354. netrisai/terraform-provider-netris
...
### 358. wacht-platform/frontend-api
...
### 367. terraform-linters/tflint-ruleset-aws
...
### 371. projectdiscovery/awesome-search-queries
...
### 373. awalsh128/cache-apt-pkgs-action
...
### 376. apache/skywalking-banyandb
...
### 379. Azure/azure-workload-identity
...
### 400. crossplane-contrib/provider-upjet-aws
...
### 401. losisin/helm-values-schema-json
...
### 404. Delta-Kronecker/V2ray-Config
...
### 405. kubevirt/hyperconverged-cluster-operator
...
### 407. sakullla/nginx-reverse-emby
...
### 422. kubernetes-sigs/kernel-module-management
...
### 429. sheawinkler/ContextLattice
...
### 433. V2RAYCONFIGSPOOL/V2RAY_SUB
...
### 434. hyperledger/fabric-x-common
...
### 435. Mellanox/doca-driver-build
