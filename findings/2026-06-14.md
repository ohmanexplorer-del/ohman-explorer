...
### 73. EternalCodeTeam/EternalCore
...
### 81. NeptuneHub/AudioMuse-AI-MusicServer
...
### 82. kagnlp/Awesome-Agentic-Security
...
### 86. IntuitionAmiga/IntuitionEngine
...
### 94. timebertt/kubectl-revisions
...
### 95. simonostendorf/kubelet-credential-provider-vault
...
### 100. procore-oss/kube-binpacking-exporter
...
### 104. simonw/scrape-fema-shelters
...
### 106. Vortalitys/PrivHunterAI-detects-access-vulnerabilities
...
### 108. Mindburn-Labs/helm-ai-kernel
...
### 113. realdatadriven/central-set-go
...
### 116. neo4j-partners/neo4j-kubernetes-operator
...
### 123. Avarok-Cybersecurity/Citadel-Protocol
...
### 125. Dash-Industry-Forum/livesim2
...
### 128. crossplane/crossplane-runtime
...
### 145. vikrantwaghmode/agentarmor-oss
...
### 151. MountainDash/nonebot-bison
...
### 159. prometheus-community/parquet-common
...
### 160. kazhuravlev/database-gateway
...
### 163. neufeldtech/secretmessage-go
...
### 176. ZaparooProject/zaparoo-core
...
### 177. themiralay/Proxy-List-World
...
### 187. pulumi/pulumi-provider-boilerplate
...
### 188. AvaProtocol/EigenLayer-AVS
...
### 192. databricks/databricks-sdk-go
...
### 193. beyond-all-reason/bar-lobby
...
### 201. home-operations/gatus-sidecar
...
### 203. Nostalgica-Reverie/Content-Monorepo
...
### 208. aws/eks-anywhere-build-tooling
...
### 210. betterstack-community/go-logging-benchmarks
...
### 217. chukwuemekawisdom/claude2api
...
### 218. guitarrapc/githubactions-lab
...
### 219. cx20/webgl-physics-examples
...
### 223. tjhop/prometheus-mcp-server
...
### 224. cagedbird043/fcm-hosts-next
...
### 226. paketo-buildpacks/dotnet-core
...
### 234. terraform-linters/tflint-ruleset-template
...
### 236. jamesroutley/news.routley.io
...
### 250. miladtahanian/Config-Collector
...
### 251. pseudoyu/top-blockchain-projects
...
### 252. batazor/microservice-template-ddd
...
### 255. armin-hg/NewCobaltstrikeTeamServer
...
### 265. Mininglamp-OSS/octo-server
...
### 266. Shade-of-Gr3y/Dream-World-Revival
...
### 267. indmdev/Telegram-Store-MiniApp
...
### 272. jr200-labs/nats-iam-broker
...
### 284. procinger/turing-pi-v2-cluster
...
### 286. ollygarden/opentelemetry-agent-skills
...
### 307. Pettor/app-pixi-image-editor
...
### 308. alanisme/awesome-zed-extensions
...
### 310. blackwell-systems/mcp-assert
...
### 311. crossplane-contrib/function-kro
...
### 321. italia/developers-italia-api
...
### 322. longhorn/longhorn-share-manager
...
### 324. zoharbabin/web-researcher-mcp
...
### 332. CustomResourceDefinition/catalog
...
### 335. jonascrevecoeur/terraform-provider-azuresql
...
### 337. paperclipinc/paperclip-operator
...
### 340. thedavidweng/monarchmoney-cli
...
### 341. thedoggybrad/easylist-mirror
...
### 352. Correia-jpv/fucking-awesome-go
...
### 354. aspect-build/aspect-gazelle
...
### 356. btelolabs/btelo-coding-release
...
### 359. k-quels/japanese-novel-ruby
...
### 362. vituha230/Neuro-Skyrim-Integration
...
### 364. BlackbirdWorks/gopherstack
...
### 370. kagenti/kagenti-extensions
...
### 375. Sarakimz/go-secrets-scanner
...
### 379. clm-cloud-solutions/kubebolt
...
### 380. d-velop/grafana-odata-datasource
...
### 381. dcssoftware/bafoeg-manager
...
### 382. dwisiswant0/nuclei-confuser
...
### 383. netrisai/terraform-provider-netris
...
### 388. wacht-platform/frontend-api
...
### 397. terraform-linters/tflint-ruleset-aws
...
### 401. projectdiscovery/awesome-search-queries
...
### 403. awalsh128/cache-apt-pkgs-action
...
### 406. apache/skywalking-banyandb
...
### 409. Azure/azure-workload-identity
...
### 430. crossplane-contrib/provider-upjet-aws
...
### 431. losisin/helm-values-schema-json
...
### 434. Delta-Kronecker/V2ray-Config
...
### 435. kubevirt/hyperconverged-cluster-operator
...
### 437. sakullla/nginx-reverse-emby
...
### 452. kubernetes-sigs/kernel-module-management
...
### 459. sheawinkler/ContextLattice
...
### 463. V2RAYCONFIGSPOOL/V2RAY_SUB
...
### 464. hyperledger/fabric-x-common
...
### 465. Mellanox/doca-driver-build
