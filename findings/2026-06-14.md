...
### 31. williamchanrico/planet-exporter
...
### 34. pulumi/pulumi-pulumiservice
...
### 41. amaanx86/oci-prometheus-sd-proxy
...
### 43. ubiquiti-community/unifi-api
...
### 45. paperclipinc/hermes-operator
...
### 46. argoproj-labs/gitops-promoter
...
### 60. AfterShip/clickhouse-sql-parser
...
### 62. Asymptote-Labs/agent-beacon
...
### 77. NeptuneHub/AudioMuse-AI-MusicServer
...
### 80. IntuitionAmiga/IntuitionEngine
...
### 87. timebertt/kubectl-revisions
...
### 88. simonostendorf/kubelet-credential-provider-vault
...
### 92. procore-oss/kube-binpacking-exporter
...
### 97. Vortalitys/PrivHunterAI-detects-access-vulnerabilities
...
### 99. Mindburn-Labs/helm-ai-kernel
...
### 104. realdatadriven/central-set-go
...
### 107. neo4j-partners/neo4j-kubernetes-operator
...
### 114. Dash-Industry-Forum/livesim2
...
### 117. crossplane/crossplane-runtime
...
### 133. vikrantwaghmode/agentarmor-oss
...
### 139. MountainDash/nonebot-bison
...
### 147. prometheus-community/parquet-common
...
### 148. kazhuravlev/database-gateway
...
### 151. neufeldtech/secretmessage-go
...
### 163. ZaparooProject/zaparoo-core
...
### 173. pulumi/pulumi-provider-boilerplate
...
### 174. AvaProtocol/EigenLayer-AVS
...
### 178. databricks/databricks-sdk-go
...
### 179. beyond-all-reason/bar-lobby
...
### 187. home-operations/gatus-sidecar
...
### 189. Nostalgica-Reverie/Content-Monorepo
...
### 194. aws/eks-anywhere-build-tooling
...
### 196. betterstack-community/go-logging-benchmarks
...
### 203. chukwuemekawisdom/claude2api
...
### 204. guitarrapc/githubactions-lab
...
### 208. tjhop/prometheus-mcp-server
...
### 209. cagedbird043/fcm-hosts-next
...
### 211. paketo-buildpacks/dotnet-core
...
### 219. terraform-linters/tflint-ruleset-template
...
### 221. jamesroutley/news.routley.io
...
### 235. miladtahanian/Config-Collector
...
### 236. pseudoyu/top-blockchain-projects
...
### 237. batazor/microservice-template-ddd
...
### 240. armin-hg/NewCobaltstrikeTeamServer
...
### 250. Mininglamp-OSS/octo-server
...
### 251. Shade-of-Gr3y/Dream-World-Revival
...
### 256. jr200-labs/nats-iam-broker
...
### 268. procinger/turing-pi-v2-cluster
...
### 270. ollygarden/opentelemetry-agent-skills
...
### 291. Pettor/app-pixi-image-editor
...
### 292. alanisme/awesome-zed-extensions
...
### 294. blackwell-systems/mcp-assert
...
### 295. crossplane-contrib/function-kro
...
### 304. italia/developers-italia-api
...
### 305. longhorn/longhorn-share-manager
...
### 307. zoharbabin/web-researcher-mcp
...
### 315. CustomResourceDefinition/catalog
...
### 318. jonascrevecoeur/terraform-provider-azuresql
...
### 320. paperclipinc/paperclip-operator
...
### 323. thedavidweng/monarchmoney-cli
...
### 334. Correia-jpv/fucking-awesome-go
...
### 336. aspect-build/aspect-gazelle
...
### 338. btelolabs/btelo-coding-release
...
### 343. vituha230/Neuro-Skyrim-Integration
...
### 345. BlackbirdWorks/gopherstack
...
### 351. kagenti/kagenti-extensions
...
### 356. Sarakimz/go-secrets-scanner
...
### 360. clm-cloud-solutions/kubebolt
...
### 361. d-velop/grafana-odata-datasource
...
### 362. dcssoftware/bafoeg-manager
...
### 363. dwisiswant0/nuclei-confuser
...
### 364. netrisai/terraform-provider-netris
...
### 368. wacht-platform/frontend-api
...
### 377. terraform-linters/tflint-ruleset-aws
...
### 381. projectdiscovery/awesome-search-queries
...
### 383. awalsh128/cache-apt-pkgs-action
...
### 386. apache/skywalking-banyandb
...
### 389. Azure/azure-workload-identity
...
### 410. crossplane-contrib/provider-upjet-aws
...
### 411. losisin/helm-values-schema-json
...
### 414. Delta-Kronecker/V2ray-Config
...
### 415. kubevirt/hyperconverged-cluster-operator
...
### 417. sakullla/nginx-reverse-emby
...
### 432. kubernetes-sigs/kernel-module-management
...
### 439. sheawinkler/ContextLattice
...
### 443. V2RAYCONFIGSPOOL/V2RAY_SUB
...
### 444. hyperledger/fabric-x-common
...
### 445. Mellanox/doca-driver-build
