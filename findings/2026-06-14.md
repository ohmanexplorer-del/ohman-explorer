...
### 35. pulumi/pulumi-pulumiservice
...
### 42. amaanx86/oci-prometheus-sd-proxy
...
### 44. ubiquiti-community/unifi-api
...
### 46. paperclipinc/hermes-operator
...
### 47. argoproj-labs/gitops-promoter
...
### 61. AfterShip/clickhouse-sql-parser
...
### 63. Asymptote-Labs/agent-beacon
...
### 78. NeptuneHub/AudioMuse-AI-MusicServer
...
### 79. kagnlp/Awesome-Agentic-Security
...
### 82. IntuitionAmiga/IntuitionEngine
...
### 89. timebertt/kubectl-revisions
...
### 90. simonostendorf/kubelet-credential-provider-vault
...
### 95. procore-oss/kube-binpacking-exporter
...
### 100. Vortalitys/PrivHunterAI-detects-access-vulnerabilities
...
### 102. Mindburn-Labs/helm-ai-kernel
...
### 107. realdatadriven/central-set-go
...
### 110. neo4j-partners/neo4j-kubernetes-operator
...
### 116. Avarok-Cybersecurity/Citadel-Protocol
...
### 118. Dash-Industry-Forum/livesim2
...
### 121. crossplane/crossplane-runtime
...
### 137. vikrantwaghmode/agentarmor-oss
...
### 143. MountainDash/nonebot-bison
...
### 151. prometheus-community/parquet-common
...
### 152. kazhuravlev/database-gateway
...
### 155. neufeldtech/secretmessage-go
...
### 168. ZaparooProject/zaparoo-core
...
### 169. themiralay/Proxy-List-World
...
### 179. pulumi/pulumi-provider-boilerplate
...
### 180. AvaProtocol/EigenLayer-AVS
...
### 184. databricks/databricks-sdk-go
...
### 185. beyond-all-reason/bar-lobby
...
### 193. home-operations/gatus-sidecar
...
### 195. Nostalgica-Reverie/Content-Monorepo
...
### 200. aws/eks-anywhere-build-tooling
...
### 202. betterstack-community/go-logging-benchmarks
...
### 209. chukwuemekawisdom/claude2api
...
### 210. guitarrapc/githubactions-lab
...
### 211. cx20/webgl-physics-examples
...
### 215. tjhop/prometheus-mcp-server
...
### 216. cagedbird043/fcm-hosts-next
...
### 218. paketo-buildpacks/dotnet-core
...
### 226. terraform-linters/tflint-ruleset-template
...
### 228. jamesroutley/news.routley.io
...
### 242. miladtahanian/Config-Collector
...
### 243. pseudoyu/top-blockchain-projects
...
### 244. batazor/microservice-template-ddd
...
### 247. armin-hg/NewCobaltstrikeTeamServer
...
### 257. Mininglamp-OSS/octo-server
...
### 258. Shade-of-Gr3y/Dream-World-Revival
...
### 263. jr200-labs/nats-iam-broker
...
### 275. procinger/turing-pi-v2-cluster
...
### 277. ollygarden/opentelemetry-agent-skills
...
### 298. Pettor/app-pixi-image-editor
...
### 299. alanisme/awesome-zed-extensions
...
### 301. blackwell-systems/mcp-assert
...
### 302. crossplane-contrib/function-kro
...
### 311. italia/developers-italia-api
...
### 312. longhorn/longhorn-share-manager
...
### 314. zoharbabin/web-researcher-mcp
...
### 322. CustomResourceDefinition/catalog
...
### 325. jonascrevecoeur/terraform-provider-azuresql
...
### 327. paperclipinc/paperclip-operator
...
### 330. thedavidweng/monarchmoney-cli
...
### 331. thedoggybrad/easylist-mirror
...
### 342. Correia-jpv/fucking-awesome-go
...
### 344. aspect-build/aspect-gazelle
...
### 346. btelolabs/btelo-coding-release
...
### 349. k-quels/japanese-novel-ruby
...
### 352. vituha230/Neuro-Skyrim-Integration
...
### 354. BlackbirdWorks/gopherstack
...
### 360. kagenti/kagenti-extensions
...
### 365. Sarakimz/go-secrets-scanner
...
### 369. clm-cloud-solutions/kubebolt
...
### 370. d-velop/grafana-odata-datasource
...
### 371. dcssoftware/bafoeg-manager
...
### 372. dwisiswant0/nuclei-confuser
...
### 373. netrisai/terraform-provider-netris
...
### 378. wacht-platform/frontend-api
...
### 387. terraform-linters/tflint-ruleset-aws
...
### 391. projectdiscovery/awesome-search-queries
...
### 393. awalsh128/cache-apt-pkgs-action
...
### 396. apache/skywalking-banyandb
...
### 399. Azure/azure-workload-identity
...
### 420. crossplane-contrib/provider-upjet-aws
...
### 421. losisin/helm-values-schema-json
...
### 424. Delta-Kronecker/V2ray-Config
...
### 425. kubevirt/hyperconverged-cluster-operator
...
### 427. sakullla/nginx-reverse-emby
...
### 442. kubernetes-sigs/kernel-module-management
...
### 449. sheawinkler/ContextLattice
...
### 453. V2RAYCONFIGSPOOL/V2RAY_SUB
...
### 454. hyperledger/fabric-x-common
...
### 455. Mellanox/doca-driver-build
