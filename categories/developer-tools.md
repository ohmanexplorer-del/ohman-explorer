...
### 7. octokit/oauth-authorization-url.js

- Link: https://github.com/octokit/oauth-authorization-url.js
- Title: octokit/oauth-authorization-url.js
...
- Small repo potential: 9.0/10
- Stars: 19
- Reason: The project is a well-scoped and production-ready library for retrieving GitHub's identity URL for the OAuth web flow.
- Strengths:
  - Universal library
  - Production-ready
  - Clear purpose
...
### 23. wondeks/unity-mcp

- Link: https://github.com/wondeks/unity-mcp
- Title: wondeks/unity-mcp
...
- Small repo potential: 8.0/10
- Stars: 22
- Reason: The project is a well-scoped and production-ready Unity MCP server library with clear purpose and English documentation.
- Strengths:
  - Tightly scoped
  - Production-ready
  - Clear documentation
...
### 36. alcounit/selenosis

- Link: https://github.com/alcounit/selenosis
- Title: alcounit/selenosis
- Description: Scalable, stateless selenium, playwright, mpc hub for Kubernetes cluster
- Category: developer-tools
- Type: unknown
- Language: Go
- Created: 2020-10-26
...
### 38. pulumi/pulumi-provider-boilerplate
...
### 42. databricks/databricks-sdk-go
...
### 47. home-operations/gatus-sidecar
...
### 49. Nostalgica-Reverie/Content-Monorepo
...
### 54. aws/eks-anywhere-build-tooling
...
### 56. betterstack-community/go-logging-benchmarks
...
### 59. cedricziel/ha-matter-binding-helper

- Link: https://github.com/cedricziel/ha-matter-binding-helper
- Title: cedricziel/ha-matter-binding-helper
...
### 63. chukwuemekawisdom/claude2api
...
### 64. guitarrapc/githubactions-lab
...
### 68. paketo-buildpacks/dotnet-core
...
- Link: https://github.com/SHAJON-404/iptv
- Title: SHAJON-404/iptv
- Description: A premium IPTV web player built with Next.js featuring 6500+ live TV channels, HLS streaming, custom playlist support, and a stunning Three.js animated UI.
- Category: developer-tools
- Type: unknown
- Language: TypeScript
- Created: 2026-05-29
...
### 73. terraform-linters/tflint-ruleset-template
...
### 74. jamesroutley/news.routley.io
...
### 86. mstykow/provenant

- Link: https://github.com/mstykow/provenant
- Title: mstykow/provenant
...
### 87. batazor/microservice-template-ddd
...
- Link: https://github.com/piro0919/macopy
- Title: piro0919/macopy
- Description: A minimal clipboard history tool for macOS — inspired by Clipy, optimized for speed and simplicity
- Category: developer-tools
- Type: unknown
- Language: Rust
- Created: 2025-04-14
...
### 91. armin-hg/NewCobaltstrikeTeamServer
...
### 104. jr200-labs/nats-iam-broker
...
### 105. luxxuria/harvester

- Link: https://github.com/luxxuria/harvester
- Title: luxxuria/harvester
- Description: Агрегатор и валидатор VLESS-конфигураций на Rust. Автоматическая проверка Ping/Speed, фильтрация по ASN и создание оптимизированн�...
- Category: developer-tools
- Type: unknown
- Language: Rust
- Created: 2026-03-22
...
- Small repo potential: 8.0/10
- Stars: 29
- Reason: { "category": "networking", "project_type": "tool", "score": 3, "novelty": 5, "maturity": 4, "small_re
- Strengths:
  - Interesting repository metadata
- Weaknesses:
  - Needs deeper review

### 106. sorafujitani/ccsession
...
### 116. procinger/turing-pi-v2-cluster
...
### 118. ollygarden/opentelemetry-agent-skills
...
### 133. Pettor/app-pixi-image-editor
...
### 134. alanisme/awesome-zed-extensions
...
- Description: An i3/sway-like tiling Wayland compositor built from niri
- Category: developer-tools
- Type: unknown
- Language: Rust
- Created: 2026-03-14
...
### 137. blackwell-systems/mcp-assert
...
### 138. crossplane-contrib/function-kro
...
### 148. italia/developers-italia-api
...
### 149. longhorn/longhorn-share-manager
...
### 151. zoharbabin/web-researcher-mcp
...
### 159. CustomResourceDefinition/catalog
...
### 163. jonascrevecoeur/terraform-provider-azuresql
...
### 164. paperclipinc/paperclip-operator
...
### 167. thedavidweng/monarchmoney-cli
...
### 177. Correia-jpv/fucking-awesome-go
...
### 178. aspect-build/aspect-gazelle
...
### 180. btelolabs/btelo-coding-release
...
### 185. BlackbirdWorks/gopherstack
...
- Link: https://github.com/fliks-app/fliks
- Title: fliks-app/fliks
- Description: Your self-hosted movie & TV library, streamable anywhere.
- Category: developer-tools
- Type: unknown
- Language: TypeScript
- Created: 2026-05-02
...
### 191. kagenti/kagenti-extensions
...
### 193. robot-head/crabka

- Link: https://github.com/robot-head/crabka
- Title: robot-head/crabka
- Description: A Rust reimplementation of Apache Kafka. Apache 2.0, derivative work. Pre-alpha.
- Category: developer-tools
- Type: unknown
- Language: Rust
- Created: 2026-05-11
...
### 195. FransDevelopment/open-agent-trust-registry

- Link: https://github.com/FransDevelopment/open-agent-trust-registry
- Title: FransDevelopment/open-agent-trust-registry
- Description: The open root-of-trust for agent identity on the internet. A public, federated registry of trusted attestation issuers — the agent runtimes authorized to vouch for agents acting on behalf of humans. Services verify age...
- Category: developer-tools
- Type: unknown
- Language: TypeScript
- Created: 2026-03-16
...
### 196. Sarakimz/go-secrets-scanner
...
### 200. clm-cloud-solutions/kubebolt
...
### 201. d-velop/grafana-odata-datasource
...
### 202. dcssoftware/bafoeg-manager
...
### 203. dwisiswant0/nuclei-confuser
...
### 204. netrisai/terraform-provider-netris
...
### 207. wacht-platform/frontend-api
...
### 213. terraform-linters/tflint-ruleset-aws
...
### 217. projectdiscovery/awesome-search-queries
...
### 219. awalsh128/cache-apt-pkgs-action
...
### 222. apache/skywalking-banyandb
...
### 225. Azure/azure-workload-identity
...
### 246. crossplane-contrib/provider-upjet-aws
...
### 247. losisin/helm-values-schema-json
...
### 250. Delta-Kronecker/V2ray-Config
...
### 251. kubevirt/hyperconverged-cluster-operator
...
### 253. sakullla/nginx-reverse-emby
...
### 268. kubernetes-sigs/kernel-module-management
...
### 275. sheawinkler/ContextLattice
...
### 279. Mellanox/doca-driver-build
