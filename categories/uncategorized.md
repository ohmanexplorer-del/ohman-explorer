...
- Title: mdlacasse/Owl
- Description: Retirement planner with great wisdom
- Category: uncategorized
- Type: unknown
- Language: Python
- Created: 2024-05-19
...
- Description: Chrome extension to track upcoming coding contests
- Category: uncategorized
- Type: unknown
- Language: JavaScript
- Created: 2025-12-10
...
- Description: A neotest adapter for C/C++ using CTest as a test runner. Supports GoogleTest, Catch2 and doctest test frameworks.
- Category: uncategorized
- Type: unknown
- Language: Lua
- Created: 2022-10-07
...
- Description: Zorbage: algebraic data types and algorithms for use in numeric processing.
- Category: uncategorized
- Type: unknown
- Language: Java
- Created: 2016-11-24
...
- Description: Post availability of new plugins and new candidate versions for the asdf version manager to Mastodon and Twitter.
- Category: uncategorized
- Type: unknown
- Language: Shell
- Created: 2020-11-22
...
- Description: SharpConsoleUI — A .NET 8+ console windowing system with overlapping windows, 30+ controls, embedded terminal emulator, canvas drawing, and async per-window threads.
- Category: uncategorized
- Type: unknown
- Language: C#
- Created: 2025-02-11
